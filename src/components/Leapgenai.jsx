...
function Leapgenai() {
  return (
    <section className="flex items-center justify-center m-[40px] px-[40px] rounded-[30px] max-md:h-fit bg-[#07020e] flex-wrap max-md:p-8 gap-[20px]">
      <div className="flex-1 flex flex-col items-center">
        <div className="flex flex-col gap-[10px]">
          ...
          <div className="flex flex-col justify-start opacity-100 flex-shrink-0 transform-none">
            <h1 className="text-[72px] font-[500] leading-[1.5em] tracking-[-2px] text-left text-gradient">
              Leapgen.ai
            </h1>
          </div>
